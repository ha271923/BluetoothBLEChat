...
public class BLECentralHelper {
    ...
    private ScanCallback mScanCallback = new ScanCallback() {
        ...
        private void processResult(ScanResult result) {
            ...
            Log.e(TAG, "New LE Device: " + device.getName() + " @ " + result.getRssi());
    ...
    public void connect(Context context, BluetoothDevice device, BLECentralChatEvents events){
        ...
        mConnectedGatt = device.connectGatt(context, false, mGattCallback, BluetoothDevice.TRANSPORT_LE);
    }
    ...
    static private final int GATT_ERROR = 0x0085; // 133 at https://android.googlesource.com/platform/external/bluetooth/bluedroid/+/android-4.4.4_r2.0.1/stack/include/gatt_api.h
    public BluetoothGattCallback mGattCallback = new BluetoothGattCallback(){
        ...
        public void onConnectionStateChange(BluetoothGatt gatt, int status, int newState) {
            ...
            if(status == BluetoothGatt.GATT_SUCCESS) {
                ...
                if(finalStatus == GATT_ERROR) // 133
                    Log.e(TAG, "finalStatus == GATT_ERROR ");
                mHandler.post(new Runnable() {
                    @Override
                    public void run() {
